...
public class MongoUtil {
    ...
    public static List<String> objectIdString(List<ObjectId> objectIds) {
        return objectIds.stream().map(objectId -> objectId.toHexString()).collect(Collectors.toList());
    }

    public static List<ObjectId> stringObjectId(List<String> objectIds) {
